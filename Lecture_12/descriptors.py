...
# -----------------------------------------------------------------------------------
# STEP 1. Напишем класс, который хранит имя ученика, его возраст, номер класса (от 1 до 11)
...
# использовать её для всех трёх свойств. Ниже полностью готовый код.
...
# std_one=Student(name=Архимед, age=12, grade=4, office=29)
# std_one=Student(name=Архимед, age=15, grade=4, office=29)
# std_one.__dict__={'name': 'Архимед', '_age': 15, '_grade': 4, '_office': 29}
...
#       командой del. В нашем примере вызываем ошибку AttributeError и ничего не удаляем.
