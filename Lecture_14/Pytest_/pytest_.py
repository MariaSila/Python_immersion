...
# напрямую.
# (venv) PS C:\Users\user\Python_immersion> python -m pytest .\Lecture_14\Pytest_\pytest_.py
# (venv) PS C:\Users\user\Python_immersion> pytest .\Lecture_14\Pytest_\pytest_.py
