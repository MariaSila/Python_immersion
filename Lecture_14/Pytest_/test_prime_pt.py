...
#       ложь в качестве результата вызова функции. Второй assert ожидает получить истину.
...
# (venv) PS C:\Users\user\Python_immersion> pytest --doctest-modules .\Lecture_14\Pytest_\test_prime_pt.py -v
# (venv) PS C:\Users\user\Python_immersion> pytest .\Lecture_14\Pytest_\test_prime_pt.py -v
# (venv) PS C:\Users\user\Python_immersion> pytest .\Lecture_14\Unittest_\test_prime.py
# -----------------------------------------------------------------------------
