...
# --------------------------------------------------------------------------------
# STEP 1. Сравнение на идентичность, __eq__
...
# ----------------------------------------------------------------------------------
# STEP 2. Сравнение на больше и меньше
...
# площадей подтверждает, что треугольники были упорядочены именно на основе их сравнения
...
# ---------------------------------------------------------------------------------------------
# STEP 3. Неизменяемые экземпляры, хеширование дандер __hash__
...
# ----------------------------------------------------------------------------------------------
# STEP 3.1. Простейшая реализация хэша
